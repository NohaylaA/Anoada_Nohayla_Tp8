package com.example.anoada_nohayla_tp8;
...
public class MainActivity extends Activity implements SensorEventListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        confidenceDebout = findViewById(R.id.textDebout);
        confidenceAssis = findViewById(R.id.textAssis);
        confidenceMarcher = findViewById(R.id.textMarche);
        confidenceSauter = findViewById(R.id.textSaute);
        confidenceCourir = findViewById(R.id.textCourir);
    }
